...
#ifndef PAYU_SDK_LITE_SWIFT_H
#define PAYU_SDK_LITE_SWIFT_H
...
SWIFT_CLASS("_TtC13PayU_SDK_Lite23PURegulationsAcceptance")
@interface PURegulationsAcceptance : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull verificationId;
...
- (nonnull instancetype)initWithVerificationId:(NSString * _Nonnull)verificationId title:(NSString * _Nonnull)title subtitle:(NSString * _Nonnull)subtitle linkText:(NSString * _Nonnull)linkText OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

@class PURegulationsAcceptanceConfig;
@class UIView;

SWIFT_CLASS("_TtC13PayU_SDK_Lite30PURegulationsAcceptanceBuilder")
@interface PURegulationsAcceptanceBuilder : NSObject
- (UIView * _Nonnull)buildWithConfig:(PURegulationsAcceptanceConfig * _Nonnull)config onAccept:(void (^ _Nullable)(void))onAccept SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13PayU_SDK_Lite29PURegulationsAcceptanceConfig")
@interface PURegulationsAcceptanceConfig : NSObject
- (nonnull instancetype)initWithVisualStyle:(PUVisualStyle * _Nonnull)visualStyle environment:(PUEnvironment)environment model:(PURegulationsAcceptance * _Nonnull)model presentingViewController:(UIViewController * _Nonnull)presentingViewController OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
